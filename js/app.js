(function () {
  ...
  // add selet option to the select element
  ...
  form.addEventListener("click", function (e) {
    ...
    if (
      ...
      <p>
        bill amoun cannot be less than zero
      </p>
      <p>
        people sharing the bill cannot be less than zero
      </p>
      <p>
        service has to be selected
      </p>
      `;
      setTimeout(function () {
  ...
  function showResults(bill, people, quality) {
    ...
    document.getElementById("person-amount").textContent = person.toFixed(1);
  }
